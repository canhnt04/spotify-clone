...
#         # Loại bỏ 'image/upload/' nếu có trong các URL
#         if 'thumbnail_url' in data and data['thumbnail_url'].startswith('image/upload/'):
#             data['thumbnail_url'] = data['thumbnail_url'].replace('image/upload/', '')
#         if 'audio_url' in data and data['audio_url'].startswith('image/upload/'):
#             data['audio_url'] = data['audio_url'].replace('image/upload/', '')
#         if 'video_url' in data and data['video_url'].startswith('image/upload/'):
